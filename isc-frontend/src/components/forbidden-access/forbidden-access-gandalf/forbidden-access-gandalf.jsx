...
// prefer `makeStyles` over imported .css
// exception made for page downloaded from internet
import "./forbiden-access-gandalf.css";

export const ForbiddenAccessGandalf = () => {
  return (
    <div className="gandalf_root">
      <svg
        className="text"
